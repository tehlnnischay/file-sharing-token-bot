...
APP_ID = int(os.environ.get("APP_ID", "21728060"))

#Your API Hash from my.telegram.org
API_HASH = os.environ.get("API_HASH", "5b0970a02db0a6235db372051a646119")
...
FORCE_SUB_CHANNEL = int(os.environ.get("FORCE_SUB_CHANNEL", "https://t.me/HMmedia_Movie"))
